...
| LSTM | 0.970±0.001 | 0.713±0.011 | 0.668±0.014 | 0.674±0.026 | 0.664±0.044 |
...
| Autoformer | 0.965±0.002 | 0.676±0.013 | 0.619±0.015 | 0.608±0.032 | 0.632±0.038 |
...
| LSTM | 0.63±0.40 | 0.970±0.001 | 0.713±0.011 | 0.679±0.010 | 0.637±0.008 | 0.727±0.030 |
...
| Autoformer | 0.51±0.55 | 0.965±0.002 | 0.676±0.013 | 0.629±0.022 | 0.588±0.012 | 0.676±0.043 |
...
| Model | AUC | AP | F1 | Precision | Recall |
|---|---|---|---|---|---|
| Crossformer | 0.977±0.001 | 0.889±0.006 | 0.817±0.006 | 0.777±0.030 | 0.865±0.035 |
...
| Transformer | 0.970±0.001 | 0.856±0.004 | 0.790±0.004 | 0.735±0.024 | 0.855±0.039 |
...
| Autoformer | 0.961±0.001 | 0.817±0.006 | 0.751±0.006 | 0.757±0.020 | 0.746±0.033 |

### (b) τ selected on validation to maximise F1

| Model | τ (°C) | AUC | AP | F1 | Precision | Recall |
|---|---|---|---|---|---|---|
| Crossformer | 0.00±0.00 | 0.977±0.001 | 0.889±0.006 | 0.817±0.006 | 0.777±0.030 | 0.865±0.035 |
...
| Transformer | 0.00±0.00 | 0.970±0.001 | 0.856±0.004 | 0.790±0.004 | 0.735±0.024 | 0.855±0.039 |
...
| Autoformer | 0.00±0.00 | 0.961±0.001 | 0.817±0.006 | 0.751±0.006 | 0.757±0.020 | 0.746±0.033 |
